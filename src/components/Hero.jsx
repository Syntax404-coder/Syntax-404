...
import bgImage from './img/bg_about.png'

const Hero = () => {
  return (
    <section id="home" className="hero" style={{ backgroundImage: `url(${bgImage})` }}>
      <div className="hero-container">
        <div className="hero-content">
          <div className="hero-greeting">Hi, I am Domenic Taganahan!</div>
          <h1 className="hero-title">
            <span className="hero-tech">TECH</span>
            <span className="hero-junkie">JUNKIE</span>
          </h1>
          <p className="hero-description">
            Passionate about exploring new technologies, software development, and digital innovation. 
            I architect intelligent web platforms and integrate cutting-edge solutions to solve real-world problems.
          </p>
          <div className="hero-buttons">
            <a href="#projects" className="btn btn-projects">PROJECTS &lt;/&gt;</a>
            <a href="#contact" className="btn btn-hire">LET'S TALK</a>
          </div>
